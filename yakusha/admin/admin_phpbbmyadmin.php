...
if (!empty($setmodules))
{
	...
	$module['ZDatabase'][' phpBB_MyAdmin'] = $file;
	return;
}
...
if(!strcmp($mode, 'submit'))
{
	if (empty($this_query))
	{
		message_die(GENERAL_MESSAGE, sprintf($lang['SQL_Admin_No_Query'], '<a href="' . $file . '" class="gen">', '</a>' , '<a href=\'' . append_sid("index.$phpEx?pane=right") . '\' class="gen">', '</a>'));
	}
	...
	foreach($queries as $query)
	{
		...
		if (!$result)
		{
			message_die(GENERAL_ERROR, sprintf($lang['SQL_Admin_Error_In_Query'], $query, '<a href="' . $file . '" class="gen">', '</a>' , '<a href=\'' . append_sid("index.$phpEx?pane=right") . '\' class="gen">', '</a>'));
		}
		// Show results or not?
		$donormaldie = TRUE;
	...
	if ($donormaldie)
	{
		message_die(GENERAL_MESSAGE, sprintf($lang['SQL_Admin_Success_Query'], $queriesdone, '<a href="' . $file . '" class="gen">', '</a>' , '<a href=\'' . append_sid("index.$phpEx?pane=right") . '\' class="gen">', '</a>'));
	}
}
// END submit
...
if(!strcmp($mode,'repairall'))
{
	...
	message_die(GENERAL_MESSAGE, sprintf($lang['SQL_Admin_Repair_Done'], $tablecount, '<a href="' . $file . '" class="gen">', '</a>' , '<a href=\'' . append_sid("index.$phpEx?pane=right") . '\' class="gen">', '</a>'));
}
// END repair all
...
if(!strcmp($mode,'optimizeall'))
{
	...
	message_die(GENERAL_MESSAGE, sprintf($lang['SQL_Admin_Optimize_Done'], $tablecount, '<a href="' . $file . '" class="gen">', '</a>' , '<a href=\'' . append_sid("index.$phpEx?pane=right") . '\' class="gen">', '</a>'));
}
// END optimize all
