...
if( !empty($setmodules) )
{
        ...
        $module['Users']['User_register'] = $filename;
        return;
}
...
if( isset($HTTP_POST_VARS['edit_email']) )
{
	$HTTP_POST_VARS['email'] = $HTTP_POST_VARS['edit_email'];
}
//
...
if ( isset($HTTP_POST_VARS['submit']) )
{
	...
	if ( !$error )
	{
		...
		$message = $lang['Account_added_admin'];
...
$template->assign_vars(array(
	...
	'L_UYE_EKLE' => $lang['Uye_ekle'],
	'L_UYE_EKLEME' => $lang['Uye_ekleme'],
