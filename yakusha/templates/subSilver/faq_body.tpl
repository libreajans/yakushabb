...
<td align="right" class="nav"> <a href="{U_FAQ}">DHTML</a></td>
</tr>
</table>
...
<tr>
<td class="spaceRow" height="1"><img src="{TEMPLATE_PATH}/images/spacer.gif" alt="" width="1" height="1" /></td>
</tr>
<!-- END faq_row -->
</table>
<!-- END faq_block -->
...
<tr>
<td align="left" valign="top" nowrap="nowrap"><span class="gensmall">{S_TIMEZONE}</span></td>
<td align="right" class="nav"> <a href="{U_FAQ}">DHTML</a></td>
</tr>
</table>
