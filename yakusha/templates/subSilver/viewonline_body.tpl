...
<tr>
<td align="left"><span class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a> &raquo; {L_WHOSONLINE}</span></td>
</tr>
</table>
...
<!-- END reg_user_row -->
<tr>
<td colspan="3" height="1" class="row3"><img src="{TEMPLATE_PATH}/images/spacer.gif" width="1" height="1" title="."></td>
</tr>
<tr>
