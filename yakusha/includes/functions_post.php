...
//
function submit_post($mode, &$post_data, &$message, &$meta, &$forum_id, &$topic_id, &$post_id, &$poll_id, &$topic_type, &$bbcode_on, &$html_on, &$smilies_on, &$attach_sig, &$bbcode_uid, $post_username, $post_subject, $post_message, $poll_title, &$poll_options, &$poll_length, &$edit_notes)
{
					...
					while (list($user_lang, $bcc_list) = each($bcc_list_ary))
					{
						...
						$emailer->assign_vars(array(
							...
							'TOPIC_TITLE' => $topic_title, 
                                                        'POSTER_USERNAME' => htmlspecialchars($userdata['username']),
