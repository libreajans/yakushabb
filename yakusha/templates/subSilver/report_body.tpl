...
<tr>
<td class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a> &raquo; {L_WRITE_REPORT} </td>
</tr>
</table>
...
<tr>
<td class="row1" nowrap="nowrap"><span class="genmed"><b>{L_CAT_SELECT}:</b></span></td>
<td class="row2" width="100%"><span class="genmed">{S_CAT_SELECT}</span></td>
</tr>
<!-- BEGIN switch_cat_explain -->
<tr>
<td class="row1" nowrap="nowrap" valign="top"><span class="genmed"><b>{L_CAT_EXPLAIN}:</b></span></td>
<td class="row2"><span class="genmed">{S_CAT_EXPLAIN}</span></td>
</tr>
<!-- END switch_cat_explain -->
<tr>
<td class="row1" nowrap="nowrap"><span class="genmed"><b>{L_INFO}:</b></span></td>
...
<span class="genmed"><b>{L_TEXT}:</b></span>
