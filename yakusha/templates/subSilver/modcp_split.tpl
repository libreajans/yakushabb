...
<form name="modcpForm" method="post" action="{S_SPLIT_ACTION}">
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
<tr>
<td align="left">
<span class="nav">
<a href="{U_INDEX}" class="nav">{L_INDEX}</a> &raquo; <a href="{U_VIEW_FORUM}" class="nav">{FORUM_NAME}</a>
</span>
</td>
</tr>
</table>
...
<!-- BEGIN postrow -->
<tr>
<td align="center" valign="top" class="{postrow.ROW_CLASS}">
<span class="name"><a name="{postrow.U_POST_ID}"></a>{postrow.POSTER_NAME}</span></td>
<td width="100%" valign="top" class="{postrow.ROW_CLASS}">
<table width="100%" cellspacing="0" cellpadding="3" border="0">
<tr>
<td valign="middle"><img src="{TEMPLATE_PATH}/images/icon_minipost.gif" alt="{L_POST}"><span class="postdetails">{L_POSTED}:
...
<tr>
<td colspan="3" height="1" class="spacerow"><img src="{TEMPLATE_PATH}/images/spacer.gif" width="1" height="1" alt="."></td>
</tr>
<!-- END postrow -->
<tr>
...
<a href="#" onclick="setCheckboxes('modcpForm', 'post_id_list[]', true); return false;">{L_MARK_ALL}</a>&nbsp;::&nbsp;
<a href="#" onclick="setCheckboxes('modcpForm', 'post_id_list[]', false); return false;">{L_UNMARK_ALL}</a></b>
</span>
</td>
</tr>
</table>
