...
<tr>
<th width="5%" class="thLeft"  height="25" valign="middle" > ID </th>
...
<th class="thHead"  height="25" valign="middle" >&nbsp;</th>
<th class="thHead"  height="25" valign="middle" >&nbsp;</th>
<th class="thRight"  height="25" valign="middle" >{L_HIDE_ON_INDEX}</th>
</tr>
<!-- BEGIN grouprow -->
<tr>
<td class="row2" align="center"><span class="gen">{grouprow.ID}</span></td>
...
<!-- BEGIN emptyswitch -->
<tr>
<td class="row1" colspan="8" align="center"><span class="gen">{L_NO_GROUPS}</span></td>
</tr>
<!-- END emptyswitch -->
<tr>
<td class="catBottom" colspan="10" align="center" height="28">
