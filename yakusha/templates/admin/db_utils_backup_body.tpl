...
<input type="hidden" name="phpbb_only" value="1" />
<tr>
...
<tr>
<td class="row1">{L_DROP_FAZLA_SORT}</td>
<td class="row1">{L_NO} <input type="radio" name="drop_search" value="0" checked />  &nbsp;{L_YES} <input type="radio" name="drop_search" value="1" /></td>
</tr>
