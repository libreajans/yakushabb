...
<td align="right">
<span class="nav"><a href="{SHOW_NO_DHTML}">HTML</a></span>
</td>
</tr>
</table>
...
<div onclick="return CFAQ.display('faq_a_reginfo', false);" style="width:100%;cursor:pointer;cursor:hand;"><span class="gen"><a class="postlink" name="reginfo" href="#reginfo" onclick="return CFAQ.display('faq_a_reginfo', true);" onfocus="this.blur();"><img src="images/cp/hesap.png"><b>{L_REGISTRATION_INFO}</b></a></span><br /><span class="gensmall">{L_ITEMS_REQUIRED}</span></div>
<div id="faq_a_reginfo" style="display:none;">
<table class="bodyline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">

<!-- BEGIN switch_namechange_disallowed -->
<tr>
<td class="row1" width="40%"><span class="gen">{L_USERNAME}: *</span></td>
<td class="row2" width="60%"><input type="hidden" name="username" value="{USERNAME}" /><span class="gen"><b>{USERNAME}</b></span></td>
</tr>
<!-- END switch_namechange_disallowed -->
<!-- BEGIN switch_namechange_allowed -->
<tr>
<td class="row1" width="40%"><span class="gen">{L_USERNAME}: *</span></td>
<td class="row2" width="60%"><input type="text" class="post" style="width:200px" name="username" size="25" maxlength="25" value="{USERNAME}" /></td>
</tr>
...
<tr>
<td class="row1"><span class="gen"><a href="{U_FAQ}#36&amp;dthtml=no" tabindex="98" target="_phpbbfaq">{L_PASSWORD_SECURITY_EXPLAIN}</a></span> </td>
<td class="row2">
...
<tr>
<td class="spaceRow" colspan="2"><img src="{TEMPLATE_PATH}/images/spacer.gif" alt="" width="0" height="0" /></td>
</tr>
</table>
</div>
</td>
...
<tr>
<td class="row1" align="left" valign="top">
<div onclick="return CFAQ.display('faq_a_proinfo', false);" style="width:100%;cursor:pointer;cursor:hand;"><span class="gen"><a class="postlink" name="proinfo" href="#proinfo" onclick="return CFAQ.display('faq_a_proinfo', true);" onfocus="this.blur();"><img src="images/cp/bilgi.png"><b>{L_PROFILE_INFO}</b></a></span><br /><span class="gensmall">{L_PROFILE_INFO_NOTICE}</span></div>
<div id="faq_a_proinfo" style="display:none;">
<table class="bodyline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">

<tr>
<td width="40%" class="row1"><span class="gen">{L_ICQ_NUMBER}:</span></td>
...
<tr>
<td class="row1" align="left" valign="top">
<div onclick="return CFAQ.display('faq_a_prefinfo', false);" style="width:100%;cursor:pointer;cursor:hand;"><span class="gen"><a class="postlink" name="prefinfo" href="#prefinfo" onclick="return CFAQ.display('faq_a_prefinfo', true);" onfocus="this.blur();"><img src="images/cp/secenek.png"><b>{L_PREFERENCES}</b></a></span></div> 			<div id="faq_a_prefinfo" style="display:none;">
<table class="bodyline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">

<tr>
<td width="40%" class="row1"><span class="gen">{L_PUBLIC_VIEW_EMAIL}:</span></td>
...
<tr>
<td class="row1" align="left" valign="top">
<div onclick="return CFAQ.display('faq_a_siginfo', false);" style="width:100%;cursor:pointer;cursor:hand;"><span class="gen"><a class="postlink" name="siginfo" href="#siginfo" onclick="return CFAQ.display('faq_a_siginfo', true);" onfocus="this.blur();"><img src="images/cp/imza.png"><b>{L_SIG_PANEL}</b></a></span></div>
<div id="faq_a_siginfo" style="display:none;">
<table class="bodyline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">

<tr>
<td width="40%" class="row1"><span class="gen">{L_SIG_PRE}</span></td>
<td width="60%" class="row2"><span class="gen">{SIGNATURE_P}</span></td>
</tr>
<tr>
...
<tr>
<td class="row1" align="left" valign="top">
<div onclick="return CFAQ.display('faq_a_avatarinfo', false);" style="width:100%;cursor:pointer;cursor:hand;"><span class="gen"><a class="postlink" name="avatarinfo" href="#avatarinfo" onclick="return CFAQ.display('faq_a_avatarinfo', true);" onfocus="this.blur();"><img src="images/cp/avatar.png"><b>{L_AVATAR_PANEL}</b></a></div>
<div id="faq_a_avatarinfo" style="display:none;">
<table class="bodyline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
...
<tr>
<td width="40%"><span class="gensmall">{L_AVATAR_EXPLAIN}</span></td>
<td width="60%" align="center"><span class="gensmall">{L_CURRENT_IMAGE}</span><br />{AVATAR}<br /><input type="checkbox" name="avatardel" />&nbsp;<span class="gensmall">{L_DELETE_AVATAR}</span></td>
</tr>
</table>
</td>
</tr>
