...
<br /><br />
<span class="gen">
<input type="text" name="confirm_code" value="" class="post" onChange="javascript:this.value=this.value.toUpperCase();" /> <b>&raquo;</b> <input type="Submit" name="submit" value="{L_BUTTON_TEXT}" class="mainoption">
</span>
<br /><br />
</td>
</tr>
