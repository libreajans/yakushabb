...
$module['Forums']['BForum_auths']   = $filename . '?' . POST_FORUM_URL . "=$forum_id";
...
'META' => '<meta http-equiv="refresh" content="3;url=' . append_sid("admin_toplu_izinler.$phpEx?" . POST_FORUM_URL . "=$forum_id") . '">')
);
$message = $lang['Forum_auth_updated'] . '<br /><br />' . sprintf($lang['Click_return_forumauth'],  '<a href="' . append_sid("admin_toplu_izinler.$phpEx?" . POST_FORUM_URL . "=$forum_id") . '">', "</a>");
...
'body' => 'admin/auth_forum_body_all.tpl')
);
...
$switch_mode = append_sid("admin_toplu_izinler.$phpEx?" . POST_FORUM_URL . "=" . $forum_id . "&adv=". $adv_mode);
...
'S_FORUMAUTH_ACTION' => append_sid("admin_toplu_izinler.$phpEx"),
