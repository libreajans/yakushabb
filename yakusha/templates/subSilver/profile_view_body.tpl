...
<tr>
<td align="left"><span class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a> &raquo; {L_ABOUT_USER}</span></td>
</tr>
</table>
...
<span class="postdetails">{POSTER_RANK}<br />{RANK_IMAGE}<br />{AVATAR_IMG}</span>
</td>
...
<tr>
<td bgcolor="{T_TD_COLOR2}"><img src="{TEMPLATE_PATH}/images/spacer.gif" width="{UPLOAD_LIMIT_IMG_WIDTH}" height="8" alt="{UPLOAD_LIMIT_PERCENT}" /></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td class="catBottom" colspan="2" align="center"><span class="gen">{U_MOD_BAN_USER}</span> {S_REPORT_USER}</td>
</tr>
<table>
