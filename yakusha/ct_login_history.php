...
$userdata = session_pagestart($user_ip, PAGE_LH);
...
}//end $ctracker_config->settings['login_history']
...
}//end $ctracker_config->settings['login_ip_check'] == 1
