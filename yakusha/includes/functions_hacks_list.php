...
/****************************************************************************
/** Sabitler ve ana deðerler
/***************************************************************************/
/*
.hl dosyalarýnýn taranacaðý alt klasör. Klasör isimlerinin sonunda
/ iþaretinin bulunmasý gerekmektedir: örnek: hl/
*/
define('HL_DIR', 'hl/');
/* E-posta þifreleme özelliði, açýk olduðu zaman e-posta adresleri
user@domain.ext => user at domain dot þeklinde görüntülenmektedir */
