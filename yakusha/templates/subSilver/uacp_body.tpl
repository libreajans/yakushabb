...
<tr>
<td class="nav"><span class="nav">{L_UACP} &raquo; <font color="red">{USERNAME}</font></span></td>
</tr>
</table>
</td>
<td align="right" nowrap="nowrap"><span class="genmed">{S_MODE_SELECT}&nbsp;{S_ORDER_SELECT}&nbsp;<input type="submit" name="submit" value="{L_SUBMIT}" class="liteoption" /></span>
</td>
</tr>
</table>
