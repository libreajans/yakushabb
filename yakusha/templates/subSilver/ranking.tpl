...
<span class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a> &raquo; {L_RANKING}</span></td>
</tr>
</table>
...
<!-- END no_userlist -->
<span class="gensmall">{ranks.RANK_TITLE}<br />{ranks.RANK_IMAGE}</span>
</td>
...
<tr>
<td class="row1" align="center" nowrap="nowrap">
<span class="gensmall">{spe_ranks.RANK_TITLE}<br />{spe_ranks.RANK_IMAGE}</span>
</td>
<!-- BEGIN userlist -->
