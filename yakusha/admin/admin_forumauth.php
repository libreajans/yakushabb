...
if( !empty($setmodules) )
{
	...
	$module['Forums']['CPermissions'] = $filename;
...
if( empty($forum_id) )
{
	...
	$template->assign_vars(array(
		...
		'L_AUTH_LINK' => $lang['Go_edit_group'],
...
else
{
	...
	$template->assign_vars(array(
		...
		'L_AUTH_TITLE' => $lang['Auth_Control_Forum'],
		'L_AUTH_EXPLAIN' => $lang['Forum_auth_explain'],
'L_AUTH_LINK' => $lang['Go_edit_forum'],
'S_SWITCH_ACTION' => append_sid("admin_forums.php?mode=editforum&amp;". POST_FORUM_URL ."=$forum_id"),
