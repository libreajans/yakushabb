...
<tr>
<td align="left"><span class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a> &raquo; {L_AVATAR_GALLERY}</span></td>
</tr>
</table>
...
<td class="row2" align="center"><table class="gensmall" border="0" cellspacing="0" cellpadding="0"><tr><td><input type="radio" name="avatarselect" value="{avatar_row.avatar_option_column.S_OPTIONS_AVATAR}" /></td><td valign="middle">{avatar_row.avatar_option_column.S_OPTIONS_AVATAR_NAME}</td></tr></table>
</td>
