...
<td class="row2"><textarea name="ban_priv_reason" rows="5" cols="30" wrap="virtual" style="width:300px;" class="post">{BAN_PRIV_REASON}</textarea></td>
</tr>
<tr>
...
<tr>
<td>
<textarea name="ban_pub_reason" rows="5" cols="35" wrap="virtual" style="width:300px;" class="post">{BAN_PUB_REASON}</textarea>
</td>
</tr>
</table>
</td>
...
<tr>
<td colspan="2">
<input type="radio" name="ban_expire_time_mode" value="absolute"{BAN_EXPIRE_TIME_MODE_ABSOLUTE} /> {L_AFTER_SPECIFIED_DATE}
</td>
</tr>
<tr>
<td width="30">
