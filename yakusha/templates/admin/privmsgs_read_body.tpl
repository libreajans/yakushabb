...
<caption>
<tr>
<td align="left" valign="bottom" width="19"><img src="{TEMPLATE_PATH}/images/hdr_left.gif" width="32" height="22" alt="" /></td>
<td align="left" class="forumheader-mid"><span class="gensmall">
<a href="{U_INDEX}" class="gensmall">{L_INDEX}</a> &raquo; {L_MESSAGE}</span>
</td>
<td align="right" class="forumheader-mid">
<span class="gensmall"><a href="{U_PRIVMSG_PREVIOUS}">{L_PRIVMSG_PREVIOUS}</a> :: <a href="{U_PRIVMSG_NEXT}">{L_PRIVMSG_NEXT}</a></span>
</td>
<td align="right" valign="bottom" width="19"><img src="{TEMPLATE_PATH}/images/hdr_right.gif" width="19" height="22" alt="" /></td>
</tr>
</caption>
</thead>
</table>
...
<table cellspacing="1" cellpadding="0" class="forumline" width="100%">
<tr>
...
<table height="70" cellspacing="0" cellpadding="5" border="0" width="100%" align="center">
<tr>
<td nowrap="nowrap">
{MESSAGE_FROM}
...
<tr>
<td width="100%">
<span class=gen><b>{POST_SUBJECT}</b></span>
</td>
...
<input type="hidden" name="p" value="{PM_ID}" />
