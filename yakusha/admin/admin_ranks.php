...
if( $mode != "" )
{
	if( $mode == "edit" || $mode == "add" )
	{
		...
		#--[  + ]--- forum rütbe tarayýcý -------------------------------
		$dir_way = 'images/ranks';
		$dir = @opendir($phpbb_root_path .'/'. $dir_way);

		$avatar_row_count = 0;
		$avatar_col_count = 0;
		$forum_icon_list .= '<table cellspacing="0" cellpadding="5" align="center" border="1"><tr><tr><td colspan="10" align="center">'.$lang['No_selected_icon'].'<input type="radio" name="rank_image" value=""></td></tr>';
		...
		$avatar_col_count++;
		$diz = "$dir_way/$dizin";
		$selected = ( $diz == $rank_info['rank_image']  ) ? 'checked="checked"' : '';
		$forum_icon_list .= "<td align='center'><img src='../$diz'><br /><input type=\"radio\" name=\"rank_image\" $selected value=\"$diz\"></td>";
